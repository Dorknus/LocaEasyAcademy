                    ...
                    Container(
                      child: wrapWithModel(
                        ...
                        child: MenuLateralAdminWidget(
                          ...
                          colorUsuario: FlutterFlowTheme.of(context).primary,
                          iconPlataforma: Icon(
                            Icons.pie_chart_outline,
                            color: FlutterFlowTheme.of(context).secondaryText,
                            size: 24.0,
                          ...
                          listDetalhes: widget!.listDetalhes,
                          acao: () async {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: FutureBuilder<
                                  List<UserDetalhesAulasSomenteRow>>(
                                future: (_model.requestCompleter ??= Completer<
                                        List<UserDetalhesAulasSomenteRow>>()
                                      ..complete(UserDetalhesAulasSomenteTable()
                                          .queryRows(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<UserDetalhesAulasSomenteRow>
                                      containerUserDetalhesAulasSomenteRowList =
                                      snapshot.data!;
                                                                      ...
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            () {
                                                                              if (listUsersItem.cargo == 'Aluno') {
                                                                                return 'Aluno';
                                                                              } else if (listUsersItem.cargo == 'Mentor Olimpo') {
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          _model.alunos =
                                                                            ...
                                                                            queryFn: (q) =>
                                                                                q.eqOrNull(
                                                                              'user_id',
                                                                              listUsersItem.userId,
                                                                            ),
                                                                          );
                                                                          _model.cursos =
                                                                              await CursoTable().queryRows(
                                                                            queryFn: (q) =>
                                                                                q,
                                                                          );
                                                                          ...
                                                                          context
                                                                              .pushNamed(
                                                                            DetalhesUsuarioWidget.routeName,
                                                                            queryParameters:
                                                                                {
                                                                              'detalhesAluno': serializeParam(
                                                                                _model.alunos,
                                                                                ParamType.SupabaseRow,
                                                                                isList: true,
                                                                              ),
                                                                              'detalhesCurso': serializeParam(
                                                                                _model.cursos,
                                                                                ParamType.SupabaseRow,
                                                                                isList: true,
                                                                              ),
