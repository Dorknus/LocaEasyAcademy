            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  FutureBuilder<List<ParticipacaoAlunosRow>>(
                    future: ParticipacaoAlunosTable().queryRows(
                      queryFn: (q) => q.eqOrNull(
                        'user_id',
                        currentUserUid,
                      ),
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<ParticipacaoAlunosRow>
                          containerParticipacaoAlunosRowList = snapshot.data!;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        _model.arquivo = getCurrentTimestamp
                                        ...
                                        _model.apiResult92r =
                                            await UploadFotoCall.call(
                                          foto: _model.uploadedLocalFile,
                                          token: currentJwtToken,
                                          pasta: currentUserUid,
                                          arquivo: _model.arquivo,
                                        );

                                        if ((_model.apiResult92r?.succeeded ??
                                            true)) {
                                          await UsersTable().update(
                                            data: {
                                              'foto':
                                                  'https://kjdgoyqiherkqmoblbzw.supabase.co/storage/v1/object/alunos/${currentUserUid}/${_model.arquivo}',
                                            },
                                            matchingRows: (rows) =>
                                                rows.eqOrNull(
                                              'user_id',
                                          ...
                                          _model.arquivoExclusao =
                                              functions.nomeArquivo(
                                                  containerUsersRow!.foto!);
                                          safeSetState(() {});
                                          if (_model.arquivoExclusao != null &&
                                              _model.arquivoExclusao != '') {
                                            _model.apiResult7dx =
                                                await DeleteFotoCall.call(
                                              token: currentJwtToken,
                                              pasta: currentUserUid,
                                              arquivo: _model.arquivoExclusao,
                                            );
                                          }
                                        }
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.cargoTextController ??=
                                                    TextEditingController(
                                              text: valueOrDefault<String>(
                                                containerUsersRow?.cargo,
                                                '- ',
                                              ),
                                            ),
