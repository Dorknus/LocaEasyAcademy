...
import 'editar_aula_widget.dart' show EditarAulaWidget;
...
class EditarAulaModel extends FlutterFlowModel<EditarAulaWidget> {
  ...
  String? _descricaoAulaTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return 'Informe a descrição da aula';
    }
  ...
  // Stores action output result for [Backend Call - API (renomearArquivo)] action in Button widget.
  ApiCallResponse? apiResultptp;

  @override
  void initState(BuildContext context) {
    inserirAulaTextControllerValidator = _inserirAulaTextControllerValidator;
    descricaoAulaTextControllerValidator =
        _descricaoAulaTextControllerValidator;
