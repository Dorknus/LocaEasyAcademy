...
class _RecuperarSenhaWidgetState extends State<RecuperarSenhaWidget> {
  ...
  void initState() {
    ...
    _model.emailRedefinicaoTextController ??= TextEditingController();
    _model.emailRedefinicaoFocusNode ??= FocusNode();
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          15.0, 0.0, 15.0, 48.0),
                                      child: Text(
                                        'Informe o e-mail para que seja enviado o pedido de recuperação',
                                        maxLines: 2,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .emailRedefinicaoTextController,
                                              focusNode: _model
                                                  .emailRedefinicaoFocusNode,
                                                  ...
                                                  builder:
                                                    ...
                                                    return WebViewAware(
                                                      child: AlertDialog(
                                                        ...
                                                        content: Text(
                                                            'Acabamos de enviar um e-mail para: ${_model.emailRedefinicaoTextController.text}, por favor confira o seu e-mail, bem como sua caixa de spam.'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
